...
# account for how often were coders unable to find the information they 
# were looking for in the source material.
...
# Kappa for dance_pres variable is ca. 0.429, which is according to
...
# Kappa for gender variable is ca. 0.492, which is according to
# Landis and Koch (1977) a moderate agreement between coders (0.41-0.60)
# according to Krippendorff (1980) results of following analysis should be 
# discounted as the value is below 0.67
...
# Kappa for observers variable is ca. 0.328, which is according to
...
# Kappa for location variable is ca. 0.361, which is according to
# Landis and Koch (1977) a fair agreement between coders (0.21-0.40)
# according to Krippendorff (1980) results of following analysis should be 
# discounted as the value is below 0.67
